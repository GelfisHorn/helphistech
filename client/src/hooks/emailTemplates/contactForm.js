    ...
    return `
            ...
            * {
            ...
            <tr>
                ...
                <img align="left" border="0" src="https://i.imgur.com/yWoFXsf.png" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 30%;max-width: 144px;" width="144"/>
            ...
            <h1 style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 22px; font-weight: 400;"><strong>Nuevo Cliente</strong></h1>
            ...
            <div style="font-size: 18px; line-height: 140%; text-align: left; word-wrap: break-word;">
                <p style="line-height: 140%;"><strong>Información del proyecto</strong></p>
            </div>
            ...
            <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                <p style="line-height: 140%;">Correo electrónico: ${email}</p>
            </div>
            ...
            <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                <p style="line-height: 140%;">Número de teléfono: ${phoneNumber}</p>
            </div>
