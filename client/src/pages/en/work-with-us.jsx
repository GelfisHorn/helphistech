...
export default function WorkWithUsPage() {
    ...
    const handleSubmit = (e) => {
        ...
        // On submit
        try {
            showMessage(false, 'The data was sent successfully', 5000);
            resetForm();
    ...
    return (
        <Layout 
            title={"Work with us"} 
            metaDesc={"Join our web development team and help create innovative solutions for our clients. Discover growth and professional development opportunities in a leading web development services company. Work with us and contribute to our clients' digital transformation!"} 
            lang={'es'}
        >
                            ...
                            <div className="flex items-center sm:items-start gap-5 relative">
                                <div className="flex flex-col justify-center sm:items-start gap-10">
                                    <div className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium h-fit lg:leading-[4rem]`}>
                                        <h1 className="text-center sm:text-left w-full">Work with us</h1>
                                    </div>
                                    <div className={`flex flex-col gap-5 ${darkMode ? 'description-dark font-light' : 'description-light'}`}>
                                        <p className="text-center sm:text-left">Join our web development team and help create innovative solutions for our clients. Discover the opportunities for growth and professional development in a leading company in web development services. Work with us and contribute to the digital transformation of our clients!</p>
                                    </div>
                                </div>
                            </div>
