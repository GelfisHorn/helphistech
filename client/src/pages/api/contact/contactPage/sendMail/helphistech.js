...
const lang = {
    "de": {
        "title": "Neues Projekt erhalten",
        "subtitle": "Ein Kunde möchte ein Projekt mit HelphisTech starten!",
        "from": "Formular über die Kontaktseite gesendet.",
    ...
    "en": {
        ...
        "subtitle": "A client wants to start a project with HelphisTech!",
        "from": "Form sent through the contact page.",
    ...
    "es": {
        "title": "Nuevo proyecto recibido",
        "subtitle": "Un cliente quiere empezar un proyecto con HelphisTech!",
        "from": "Formulario enviado a través de la página de contacto.",
    ...
    try {
        ...
        await transporter.sendMail({
            ...
            text: `
                ...
                ${lang[language].from}\n
            `,
            html: template.helphistech({ project, lang: lang[language] })
        });
