    ...
    return (
        <div className={`${darkMode ? 'border-neutral-800' : 'border-neutral-400'} rounded-sm py-4 relative`}>
            ...
            <div className="flex items-center gap-2 xs:absolute pt-4 xs:pt-0 bottom-3 right-3">
                ...
                <Link href={`/dashboard/process/entry/${entry._id}`} className={`p-2 rounded-full ${darkMode ? 'bg-neutral-900 hover:bg-neutral-800' : 'bg-neutral-300 hover:bg-neutral-400'} transition-colors`}>
