                            ...
                            <>
                                    ...
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div className={'flex flex-col gap-3 w-full'}>
                                            ...
                                            {/* <div className="flex justify-between items-start">
                                                ...
                                                />
                                                <select name="" id="" className={`bg-transparent px-2 video-call-select outline-none border rounded-full ${darkMode ? 'border-neutral-800' : 'border-neutral-200'} px-2 py-1`} value={hour} onChange={(e) => setHour(e.target.value)}>
                                ...
                                <div className="flex gap-x-8 gap-y-4 text-white w-full flex-wrap justify-center self-end">
                                    ...
                                    <button 
                                        ...
                                        className={`btn-primary flex max-w-[240px] items-center justify-center gap-1 py-2 px-4 bg-primary hover:bg-primary-2 transition-colors rounded-full uppercase text-center cursor-pointer w-full`}>
                                        <span>Siguiente</span>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                ...
                                <>
                                    <div className="flex flex-col gap-5">
                                        <button type="button" onClick={() => setFormStep(FORM_STEPS.DATE_PICKER)} className="py-1 px-3 pr-5 rounded-full border border-zinc-300 flex items-center w-fit">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" stroke-linejoin="round">
