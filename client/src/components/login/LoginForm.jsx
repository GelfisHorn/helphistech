        ...
        <form className="flex flex-col gap-8" onSubmit={handleSignIn}>
            <div className="flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="text-light-subtitle">Sie haben noch kein Konto? <Link className={"text-primary hover:text-primary-2 transition-colors"} href={"/#my-project"}>Starten Sie ein Projekt mit uns</Link></div>
                </div>
                ...
                <div className="flex justify-end lazy-load-3">
                    <Link className={`w-fit ${darkMode ? 'text-dark-text hover:text-white' : 'hover:text-light-main'} transition-colors`} href={`/recover-password`}>Passwort wiederherstellen</Link>
                </div>
            </div>
