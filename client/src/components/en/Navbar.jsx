                ...
                <div className={`flex items-center justify-between h-20 px-10 text-${darkMode ? 'dark' : 'light'}`}>
                    ...
                    <div className="hidden sm:flex items-center gap-3">
                        ...
                        <div onClick={() => redirectToSection("my-project")}>
                            <button className={`btn-primary py-2 px-4 uppercase font-medium text-white bg-primary hover:bg-primary-2 transition-colors rounded-sm`}>Start project</button>
                        </div>
                    </div>
