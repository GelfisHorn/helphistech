                    ...
                    <div className="hidden sm:flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="text-lg">
                                <select className="cursor-pointer bg-transparent outline-none" name="" id="" value={'en'} onChange={handleChangeLanguage}>
                        ...
                        <div onClick={() => handleNavButton("my-project")}>
                            <button className={`btn-primary py-2 px-4 uppercase font-medium text-white bg-primary hover:bg-primary-2 transition-colors rounded-sm`}>Start my project</button>
                        </div>
                    </div>
